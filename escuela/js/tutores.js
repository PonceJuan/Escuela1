...
let idTutor;
    ...
    //Crea los botones que se van a usar en esta lista
       //Crea los botones que se van a usar en esta lista
    let botones = "<div class='wrapper text-center'><div class='btn-group'><button class='btnVer btn btn-primary' data-toggle='tooltip' title='Editar Datos'>"+window.iconoEditar+"</button><button class='btnLista btn btn-success' data-toggle='tooltip' title='Mostrar Lista'>"+window.iconoVer+"</button></div></div></div></div>"
